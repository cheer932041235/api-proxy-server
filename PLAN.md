...
| 项目 | 费用 | 说明 |
|------|------|------|
| VPS（海外轻量） | ~¥99/年 起 | 2C 4GB 60GB，已付到 2027-04 |
| ChatGPT Plus | ¥100/月 × N | N 由使用强度决定（个人 1 个、共用 2-3 个、重度 5+） |
| 域名 | ~¥60/年 | 任选一个你拥有的域名 |
| ChatGPT Pro（可选） | ¥1500/月 | 高端模型 / o1-pro，按需购买 |

**典型组合（个人自用）**：VPS ¥99/年 + 域名 ¥60/年 + Plus ¥100/月 = 约 ¥113/月
**典型组合（小团队）**：VPS ¥99/年 + 域名 ¥60/年 + Plus ¥100/月 × 2 = 约 ¥213/月
